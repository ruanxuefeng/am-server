...
public class TestAdminUserController$delete {
    public static final String URL = Constant.ADMIN_ROOT + "/user/delete";
    ...
    public void idNull() throws Exception {
        ResultActions resultActions = mockMvc.perform(
                ...
                .andExpect(MockMvcResultMatchers.content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andExpect(MockMvcResultMatchers.jsonPath("$.message").value(message.get("common.delete.primaryKey.null").getMessage()));
    ...
    public void deleteSelf() throws Exception {
        ResultActions resultActions = mockMvc.perform(
                ...
                .andExpect(MockMvcResultMatchers.status().is(400))
                .andExpect(MockMvcResultMatchers.content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andExpect(MockMvcResultMatchers.jsonPath("$.message").value(message.get("user.not.allow.deleteYourself").getMessage()));
    ...
    public void test() throws Exception {
        ResultActions resultActions = mockMvc.perform(
                ...
                .andExpect(MockMvcResultMatchers.content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andExpect(MockMvcResultMatchers.jsonPath("$.message").value(message.get("common.delete.success").getMessage()));
